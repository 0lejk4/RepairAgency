...
public class OrderPaginationFormTest {
    @Parameterized.Parameters
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {"1", "1", "true", "id", true, Collections.emptyList()},
                {"1", "1", "true", "author_id", true, Collections.emptyList()},
                {"", "1", "true", "price", false, Collections.singletonList(Alert.danger("required.pageStr"))},
                {"1", "", "true", "master_id", false, Collections.singletonList(Alert.danger("required.countStr"))},
                {"1", "1", "", "done", false, Collections.singletonList(Alert.danger("required.ascendingStr"))},
    ...
    @Test
    public void valid() {
        OrderPaginationForm form = new OrderPaginationForm(pageStr, countStr, ascendingStr, orderField);
